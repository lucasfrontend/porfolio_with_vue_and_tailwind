  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <footer class="grid grid-col-6 sticky top-0 left-0 pt-6 pr-6">
        <div class="flex flex-col">
          <div class="flex justify-end">
              <button class="bg-gray-300 hover:bg-lightest text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
    ...
    <section class="bg-dark flex min-h-screen justify-center px-4">
      <div class="">
        <div class="mt-12">
          <div>
              <h3 class="text-white text-2xl  mb-6">QUALITY</h3>
          ...
          <div class="">
            ...
            <ul>
              <li class="relative flex items-baseline gap-6">
                ...
                <div>
                  <i18n tag="p" path="about.coderhouse" class="text-sm text-gray-200">
                    <template #linkcoder>
        ...
        <div class="flex flex-col justify-start">
          ...
          <div class="flex rounded pt-8">
            ...
            <h3 class="text-2xl lg:text-3xl text-white  ml-4 flex items-center">API's</h3>
          </div>
          ...
          <div class="grid grid-cols-6 grid-rows-4 py-8 items-center">
            ...
            <p class="my-6 col-span-5 text-lightest text-lg ">Amazon Web Services</p>
            <div class="flex items-center justify-start space-x-3">
              <svg class="h-8 w-8" viewBox="0 0 128 128">
            ...
            <p class="my-6 col-span-5 text-lightest text-lg ">Google Maps API</p>
            <div class="flex items-center justify-start space-x-3">
              <svg class="h-8 w-8" viewBox="0 0 128 128">
                <path fill="#ea4535" d="M80.6 40.3h.4l-.2-.2 14-14v-.3c-11.8-10.4-28.1-14-43.2-9.5C36.5 20.8 24.9 32.8 20.7 48c.2-.1.5-.2.8-.2 5.2-3.4 11.4-5.4 17.9-5.4 2.2 0 4.3.2 6.4.6.1-.1.2-.1.3-.1 9-9.9 24.2-11.1 34.6-2.6h-.1z"></path>
                <path fill="#557ebf" d="M108.1 47.8c-2.3-8.5-7.1-16.2-13.8-22.1L80 39.9c6 4.9 9.5 12.3 9.3 20v2.5c16.9 0 16.9 25.2 0 25.2H63.9v20h-.1l.1.2h25.4c14.6.1 27.5-9.3 31.8-23.1 4.3-13.8-1-28.8-13-36.9z"></path>
            ...
            <p class="my-6 col-span-5 text-lightest text-lg ">Google Places API</p>
            <div class="flex items-center justify-start space-x-3">
            ...
            <p class="my-6 col-span-5 text-lightest text-lg ">Stripe</p>
          </div>
          <div class="flex rounded">
            ...
            <h3 class="text-2xl lg:text-3xl text-lightest  ml-4 flex items-center justify-center">Tech Stack</h3>
          </div>
          <div class="grid grid-cols-6 grid-rows-3 py-8 items-center">
            ...
            <h3 class="my-4 col-span-5 text-lightest text-lg ">Python</h3>
            <div class="flex items-center justify-start space-x-3">
              <svg class="h-8 w-8" viewBox="0 0 128 128">
                <g fill="violet">
            ...
            <h3 class="my-4 col-span-5 text-lightest text-lg ">React</h3>
            <div class="flex items-center justify-start space-x-3">
              <svg class="h-8 w-8" viewBox="0 0 128 128">
            ...
            <h3 class="my-4 col-span-5 text-lightest text-lg ">Sass</h3>
